    ...
    if image is not None and predict_btn:
        try:
            if prediction_mode == "Несколько моделей (ensemble)" and len(selected_models) == 0:
                ...
                <div style="color:#8aaa8a;font-size:0.8rem;margin-top:1rem;text-transform:uppercase">
                Уверенность
                </div>
                
                <div style="font-size:1.8rem;color:#7dde7d;font-weight:700">
                {top['confidence']:.2f}%
                </div>
                ...
                <div style="font-size:1.5rem;color:#ffd580;font-weight:700">
                {price_text}
                </div>
                
                <div style="font-size:0.75rem;color:#4a7a4a;margin-top:0.5rem">
                ⚡ {elapsed*1000:.0f} ms
                </div>
